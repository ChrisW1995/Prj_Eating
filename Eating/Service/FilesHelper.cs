...
namespace Eating.Service
{
    public class FilesHelper
    {
        ...
        ICollection<string> listNames;
        public FilesHelper(String DeleteURL, String DeleteType, String StorageRoot, String UrlBase, String tempPath, String serverMapPath, ICollection<string> listNames)
        {
        ...
        {
            var R_Id = requestContext.Request.Cookies["idCookie"].Values["r_id"];
