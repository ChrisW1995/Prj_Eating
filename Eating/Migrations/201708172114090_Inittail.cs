namespace Eating.Migrations
{
    ...
    public partial class Inittail : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        CountryName = c.String(maxLength: 5),
                    })
                .PrimaryKey(t => t.Id);
            ...
            CreateTable(
                ...
                c => new
                    {
                        R_Account = c.String(nullable: false, maxLength: 25),
                        R_Password = c.String(nullable: false, maxLength: 25),
                        R_Name = c.String(nullable: false, maxLength: 50),
                        R_PhoneNum = c.String(nullable: false, maxLength: 15),
                        R_Address = c.String(nullable: false, maxLength: 100),
